...
Usage:
  bun run dashboard/orchestrator/index.ts [options]
...
Examples:
  # Basic usage
  bun run dashboard/orchestrator/index.ts

  # With environment variables
  ORCHESTRATOR_MAX_AGENTS=8 ORCHESTRATOR_DASHBOARD_URL=http://localhost:3000 bun run dashboard/orchestrator/index.ts

  # Dry run to check configuration
  bun run dashboard/orchestrator/index.ts --dry-run
`);
}
