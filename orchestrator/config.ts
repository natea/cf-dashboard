...
export function loadConfig(): OrchestratorConfig {
  return {
    ...
    useClaudeFlow:
      process.env.ORCHESTRATOR_USE_CLAUDE_FLOW !== undefined
        ? process.env.ORCHESTRATOR_USE_CLAUDE_FLOW === "true"
        : DEFAULT_CONFIG.useClaudeFlow,
  };
}
...
export function printConfig(config: OrchestratorConfig): void {
  ...
  console.log(`  Use Claude Flow: ${config.useClaudeFlow}`);
}
